    ...
    <main>
        ...
        <form action="" method="post" class="formulario" enctype="multipart/form-data">
            ...
            <div class="group">
                ...
                <input type="number" name="estoque_total" placeholder="Digite o Estoque total" required>
            </div>
            <div class="group">
            ...
            <button type="submit" class="btnSalvar" name="salvar"><i class="fas fa-plus"></i> Adicionar produto</button>
